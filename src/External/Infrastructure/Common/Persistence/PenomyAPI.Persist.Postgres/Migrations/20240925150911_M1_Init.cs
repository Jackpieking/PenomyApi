    ...
    public partial class M1_Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_penomy_user_post_like_statistics", x => new { x.PostId, x.Value });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_penomy_group_post_like_statistic", x => new { x.PostId, x.Value });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_penomy_user_post_comment_like_statistics", x => new { x.CommentId, x.Value });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_penomy_group_post_comment_like_statistic", x => new { x.CommentId, x.Value });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_penomy_chat_message_like_statistic", x => new { x.ChatMessageId, x.Value });
                    table.ForeignKey(
