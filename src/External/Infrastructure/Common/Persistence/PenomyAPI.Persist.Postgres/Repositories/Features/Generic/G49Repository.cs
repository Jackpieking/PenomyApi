    ...
    )
    {
        ...
        return await executionStrategy.ExecuteAsync(async () =>
        {
            ...
            try
            {
                ...
                var existingRating = await _userRatingArtwork.FirstOrDefaultAsync(
                    a => a.UserId == userId && a.ArtworkId == artworkId,
                    token
                );
                ...
                {
                    // Add a new rating
                    await _userRatingArtwork.AddAsync(
                        new UserRatingArtwork
                        {
                            UserId = userId,
                            ArtworkId = artworkId,
                            StarRates = starRates
                ...
                else
                {
                    ...
                    await _userRatingArtwork
                        ...
                        .ExecuteUpdateAsync(
                            update => update.SetProperty(a => a.StarRates, starRates),
                            token
                        );
                }
