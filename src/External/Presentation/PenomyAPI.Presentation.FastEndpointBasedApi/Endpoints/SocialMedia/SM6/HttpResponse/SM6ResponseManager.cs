...
namespace PenomyAPI.Presentation.FastEndpointBasedApi.Endpoints.SM6.HttpResponse;

public class SM6ResponseManager
{
    private static ConcurrentDictionary<
        SM6ResponseStatusCode,
        Func<SM6Request, SM6Response, SM6HttpResponse>
    > _dictionary;
    ...
    internal static Func<SM6Request, SM6Response, SM6HttpResponse> Resolve(
