...
namespace PenomyAPI.Presentation.FastEndpointBasedApi.Endpoints.FeatSM5.Middlewares;

public class SM5AuthPreProcessor : PreProcessor<SM5RequestDto, SM5StateBag>
{
    private readonly Lazy<SecurityTokenHandler> _securityTokenHandler;
    private readonly TokenValidationParameters _tokenValidationParameters;

    public SM5AuthPreProcessor(
    ...
    public override async Task PreProcessAsync(
        IPreProcessorContext<SM5RequestDto> context,
        SM5StateBag state,
