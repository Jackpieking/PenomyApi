...
namespace PenomyAPI.Presentation.FastEndpointBasedApi.Endpoints.FeatG4.Middlewares;

public class G4AuthPreProcessor : PreProcessor<G4RequestDto, G4StateBag>
{
    private readonly Lazy<SecurityTokenHandler> _securityTokenHandler;
    private readonly TokenValidationParameters _tokenValidationParameters;

    public G4AuthPreProcessor(
    ...
    public override async Task PreProcessAsync(
        IPreProcessorContext<G4RequestDto> context,
        G4StateBag state,
