...
{
    public class G25CountArtViewedEndpoint : Endpoint<G25CountArtViewedRequest, G25CountArtViewedHttpResponse>
    {
        ...
        public override async Task<G25CountArtViewedHttpResponse> ExecuteAsync(G25CountArtViewedRequest request, CancellationToken ct)
        {
            ...
            var featResponse = await FeatureExtensions.ExecuteAsync<G25CountArtViewedRequest, G25CountArtViewedResponse>(
                featRequest,
                ct
            );
