...
public class G59Endpoint : Endpoint<G59RequestDto, G59HttpResponse>
{
    public override void Configure()
    {
        ...
        {
            summary.Summary = "Endpoint for getting artwork reply comment.";
            summary.Description = "This endpoint is used for getting artwork reply comment.";
    ...
    public override async Task<G59HttpResponse> ExecuteAsync(
        G59RequestDto req,
        CancellationToken ct
    )
    {
        var featG59Request = new G59Request
        {
        ...
        var featResponse = await FeatureExtensions.ExecuteAsync<G59Request, G59Response>(
            featG59Request,
            ct
        );
        ...
        var httpResponse = G59HttpResponseManager
            ...
            .Invoke(featG59Request, featResponse);
