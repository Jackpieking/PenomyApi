...
public class G54Endpoint : Endpoint<G54Request, G54HttpResponse>
{
    ...
    {
        var G54Request = new G54Request { ArtworkCommentId = req.ArtworkCommentId };

        // Get FeatureHandler response.
        var featResponse = await FeatureExtensions.ExecuteAsync<G54Request, G54Response>(
            G54Request,
            ct
        );
        ...
        {
            httpResponse.Body = new G54ResponseDto { IsSuccess = featResponse.IsSuccess };
