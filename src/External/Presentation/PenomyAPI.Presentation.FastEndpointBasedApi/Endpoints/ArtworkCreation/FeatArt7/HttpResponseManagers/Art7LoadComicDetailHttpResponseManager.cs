...
public static class Art7LoadComicDetailHttpResponseManager
{
    ...
    private static void Init()
    {
        ...
        _dictionary.TryAdd(
            ...
            value: (response) => new()
            {
                AppCode = Art7LoadComicDetailHttpResponse.GetAppCode(Art7LoadComicDetailResponseStatusCode.SUCCESS),
                ...
                Body = new DTOs.Art7LoadComicDetailResponseDto
                {
                    ...
                    SelectedCategories = response.ComicDetail.ArtworkCategories
                        .Select(artworkCategory => new DTOs.Art7ArtworkCategoryDto
                        {
        ...
        _dictionary.TryAdd(
            ...
            value: (response) => new()
            {
                AppCode = Art7LoadComicDetailHttpResponse.GetAppCode(Art7LoadComicDetailResponseStatusCode.ID_NOT_FOUND),
