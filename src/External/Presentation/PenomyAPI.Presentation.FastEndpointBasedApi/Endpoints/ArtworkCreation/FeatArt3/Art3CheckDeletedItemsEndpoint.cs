...
public class Art3CheckDeletedItemsEndpoint : Endpoint<EmptyRequest, Art3CheckDeletedItemsHttpResponse>
{
    public override void Configure()
    {
        ...
        Summary(summary =>
        {
            summary.Summary = "Endpoint for checking if the current creator account has any deleted artworks.";
            summary.Description = "This endpoint is used for checking if the current creator account has any deleted artworks.";
        ...
        CancellationToken ct)
    {
        ...
        var request = new Art3CheckDeletedItemsRequest
        {
            CreatorId = stateBag.AppRequest.UserId
        };

        var featureResponse = await FeatureExtensions
            .ExecuteAsync<Art3CheckDeletedItemsRequest, Art3CheckDeletedItemsResponse>(request, ct);
